...
pressão do pneu lida pela bomba, indica a diferença entre a pressão desejada
e a pressão lida.
...
//Exemplos de entrada: 30, 20
//Exemplos de saída: 12
*/

let presaoDesejada = parseInt(30);
let presaoLida = parseInt(18);

console.log(presaoDesejada - presaoLida); //12